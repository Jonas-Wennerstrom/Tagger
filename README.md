...
![Looking up files](Jonas-Wennerstrom/Tagger/Screens/lookup.jpg)
...
![Result screen](Jonas-Wennerstrom/Tagger/Screens/result.jpg)
...
![Adding files](Jonas-Wennerstrom/Tagger/Screens/add.jpg)
Adding a new file is quite straightforward. Note the ability to get title and path from a file.
![Help menu](Jonas-Wennerstrom/Tagger/Screens/help.jpg)
